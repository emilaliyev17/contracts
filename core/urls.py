...
urlpatterns = [
    ...
    path('contracts/<int:contract_id>/pdf/', views.contract_pdf_proxy, name='contract_pdf'),
    ...
    path('contracts/<int:contract_id>/update-payment-terms/', views.update_payment_terms, name='update_payment_terms'),
    ...
    path('accounting/export/', views.export_accounting, name='export_accounting'),
